        ...
        <div className="relative w-full bg-white h-[calc(100vh-6rem)]">
            <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
                ...
                <div className="relative lg:col-span-5 lg:-mr-8 xl:col-span-6">
                    <Image
                     className="aspect-[3/2]  bg-gray-50 object-cover lg:aspect-[4/3] lg:h-[700px] xl:aspect-[16/9] block md:hidden"
                    //   <!-- Added class "block md:hidden" to make it visible on mobile (up to medium screen size) -->
                    src="/slide1.png"
                    alt=""
                    layout='fill'
                    />
